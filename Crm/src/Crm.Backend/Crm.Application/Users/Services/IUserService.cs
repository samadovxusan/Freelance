...
namespace Crm.Application.User.Services;
...
public interface IUserService
{
    ...
    ValueTask<Domain.Entities.User?> GetByIdAsync(Guid userId, QueryOptions queryOptions = default,
    ...
    ValueTask<Domain.Entities.User> CreateAsync(Domain.Entities.User user, CommandOptions commandOptions = default,
        CancellationToken cancellationToken = default);
    ...
    ValueTask<Domain.Entities.User> UpdateAsync(Domain.Entities.User user, CommandOptions commandOptions = default,
        CancellationToken cancellationToken = default);
    ...
    ValueTask<Domain.Entities.User?> DeleteByIdAsync(Guid userId, CommandOptions commandOptions = default,
        CancellationToken cancellationToken = default);
}